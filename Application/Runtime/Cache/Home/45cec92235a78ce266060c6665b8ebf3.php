...
<body>
	...
	<link rel="stylesheet" type="text/css" href="/Public/css/Home/news.css"/>
	<link rel="stylesheet" type="text/css" href="/Public/css/Home/news_con.css"/>
	<title>新闻详细</title>
	<title>新闻中心</title>
	...
	<script src="/Publicjs/base.js" type="text/javascript" charset="utf-8"></script>
	<script>
        var indexUrl = "<?php echo U('Index/index');?>";

	</script>
	<script src="/Public/js/breadcrumb.js" type="text/javascript" charset="UTF-8"></script>
...
<div class="container header_container">
    <header>
        <h1 class="pull-left"><a href="<?php echo U('Index/index');?>"><img src="/Public/images/Home/logo6.png"/></a></h1>
        <h3 class="nav-right">
...
<!--新闻详细内容-->
<div class="news_html news_con_html">
	<div class="container">
		<div class="base_nav">
			<ul>
				<li <?php if($cid == 31): ?>class="base_nav_active"<?php endif; ?> ><a href="<?php echo U('News/index' ,array('cid' => 31));?>">海洋知识</a></li>
				<li <?php if($cid == 32): ?>class="base_nav_active"<?php endif; ?> ><a href="<?php echo U('News/index' ,array('cid' => 32));?>">公司新闻</a></li>
				<li <?php if($cid == 33): ?>class="base_nav_active"<?php endif; ?> ><a href="<?php echo U('News/index' ,array('cid' => 33));?>">行业动态</a></li>
				<li <?php if($cid == 34): ?>class="base_nav_active"<?php endif; ?> ><a href="<?php echo U('News/index' ,array('cid'=>'34'));?>">活动公告</a></li>
			</ul>
		</div>
		
		<div class="news_con_html_con">
			<h4 class="h4"><?php echo ($info["title"]); ?></h4>
			<i class="active_this set_width"></i>
			<small class="small">作者：<?php echo ($info["author"]); ?>   来源：广东海启星海洋科技有限公司   日期：<?php echo (date('Y-m-d H:i:s',$info["addtime"])); ?></small>
...
<footer>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 footer_right">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <img class="img-responsive" src="/Public/images/Home/wechat.png"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--添加底部底纹-->
    <img src="/Public/images/Home/footer.png"/>
</footer>