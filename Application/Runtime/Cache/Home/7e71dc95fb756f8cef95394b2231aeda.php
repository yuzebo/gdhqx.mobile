...
<body>
	...
	<link rel="stylesheet" type="text/css" href="/hqx/Public/css/Home/news_con.css"/>
	<title>新闻详细</title>
...
<div id="myCarousel" class="carousel slide">
	<img src="/hqx/Public/images/Home/intro.png">
</div>
...
<div class="news_html news_con_html">
	<div class="container">
		<div class="base_nav">
			<ul>
				<li <?php if($cid == 43): ?>class="base_nav_active"<?php endif; ?>><a href="<?php echo U('Intro/intro' ,array('cid' => 43));?>">公司简介</a></li>
				<li <?php if($cid == 44): ?>class="base_nav_active"<?php endif; ?>><a href="<?php echo U('Intro/intro' ,array('cid' => 44));?>">企业文化</a></li>
				<li <?php if($cid == 45): ?>class="base_nav_active"<?php endif; ?>><a href="<?php echo U('Intro/intro' ,array('cid' => 45));?>">资质认证</a></li>
				<li <?php if($cid == 46): ?>class="base_nav_active"<?php endif; ?>><a href="<?php echo U('Intro/intro' ,array('cid' => 46));?>">人才招聘</a></li>
			</ul>
		</div>
		
		<div class="news_con_html_con" style="width: 950px;">
