...
<body>
	...
	<script>
        ...
        var breadcrumbUrl = "<?php echo U('Home/Five/object/cid');?>" + '/' + c_id;
	</script>
...
<div class="news_html news_con_html">
	<div class="container">
		<div class="base_nav">
			<ul>
				<li <?php if($cid == 2): ?>class="base_nav_active"<?php endif; ?>><a href="<?php echo U('Five/object', array('cid' => 2));?>">基础领域</a></li>
