...
<body>
	...
	<script src="/hqx/Publicjs/base.js" type="text/javascript" charset="utf-8"></script>
	<script>
        var indexUrl = "<?php echo U('Index/index');?>";
        var c_id = "<?php echo ($cid); ?>";
        var breadcrumbUrl = "<?php echo U('News/index/cid');?>" + '/' + c_id;
	</script>
...
<div class="news_html news_con_html">
	<div class="container">
		...
		<div class="news_con_html_con">
			...
			<i class="active_this set_width" style="margin-top: 10px"></i>
