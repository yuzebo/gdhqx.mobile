                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><p style="text-indent:<?php echo ($vo['level']*20); ?>px;"><?php echo ($vo["title"]); ?></p></td>
                                <td><?php echo ($vo["name"]); ?></td>
                                <td><?php echo ($vo["sort"]); ?></td>
                                <td><?php if($vo['level'] == 1): ?>海启星<?php elseif($vo['level'] == 2): ?><div style="color:green">一级菜单</div><?php else: ?><div style="color:blue">二级菜单</div><?php endif; ?></td>
                                <td><a href="<?php echo U('Article/deleteArticle',array('id'=>$vo['id']));?>">删除</a></td>
