    ...
    <div class="dialog">
        <div class="block">
            ...
            <div class="block-body">
                <form action="<?php echo U('Admin/Login/login');?>" method="post" name="login">
                    <label>Username</label>
                    <input type="text" class="span12" name="username" value="<?php echo ($_COOKIE['username']); ?>">
                    <label>Password</label>
                    <input type="password" class="span12" name="password">
                    <input type="submit" class="btn btn-primary pull-right" value="Sign In"></input>
