                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form action="<?php echo U('Admin/Article/updateArticleHandle');?>" method="post" id="form" name="form" onsubmit="return checksubmit()">
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="cid">
                                                ...
                                                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["id"] == $update[0][cid]): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["html"]); ?>|<?php echo ($vo["title"]); ?></option>
                                                        <?php else: ?>
                                                        <option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["html"]); ?>|<?php echo ($vo["title"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="title" id="title" value="<?php echo ($update[0][title]); ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">作者：</td>
                                        <td>
                                            <input type="text" name="author" id="author" value="<?php echo ($update[0][author]); ?>">
                                        </td>
                                    </tr>
                                    <td align="right" >发布时间：</td>
                                    <td>
                                        <input type="text" name="addtime" id="addtime" placeholder="时间格式Y-m-d H:i:s" value="<?php echo (date('Y-m-d H:i:s',$update[0][addtime])); ?>">
                                    </td>
                                    <tr>
                                        <td align="right">简介：</td>
                                        <td>
                                            <textarea name="brief" id="brief" style="width: 500px; height: 150px;"><?php echo ($update[0][brief]); ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr style="height: 200px" >
                                        <td>
                                            ...
                                            <input type="hidden" value="<?php echo ($update[0][max]); ?>" name="max" id="max">
                                        </td>
                                        <td>
                                            <img id="img" src="/Uploads/Face/<?php echo ($update[0][max]); ?>" style="border:solid 1px #000;width:300px;height:200px">
                                        </td>
                                    </tr>
                                </table>
                                <br/><br/>
