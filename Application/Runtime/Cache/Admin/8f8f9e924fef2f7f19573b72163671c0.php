            ...
            <tr>
                ...
                <td>
                    <select name="cid" id="cid">
                        ...
                        <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["id"] == $update[0][cid]): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected" class="search"><?php echo ($vo["html"]); ?>|<?php echo ($vo["title"]); ?></option>
                                <?php else: ?>
                                <option value="<?php echo ($vo["id"]); ?>" class="search"><?php echo ($vo["html"]); ?>|<?php echo ($vo["title"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
        </table>
                ...
                <div class="well">
                    <table class="table mytable">
                        ...
                        <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($vo['Cate']['title']); ?></td>
                                <td><?php echo ($vo['User'][0]['username']); ?></td>
                                <td>
                                    <a href="<?php echo U('Article/updateArticle',array('article_id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
                                    <a href="<?php echo U('Article/deleteArticle',array('article_id'=>$vo['id']));?>"><i class="icon-remove"></i></a>
                                </td>
