            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="<?php echo U('Article/addCateHandle');?>" method="post" name="form" id="form">
                            <label>英文名称：</label>
                            ...
                            <select name="pid" class="input-xlarge">
                                ...
                                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["level"] == 1): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option>
                                        <?php else: ?>
                                        <?php if($vo["level"] == 2): ?><option value="<?php echo ($vo["id"]); ?>">&nbsp;&nbsp;|&nbsp;<?php echo ($vo["title"]); ?></option>
                                            <?php else: ?><option value="<?php echo ($vo["id"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;<?php echo ($vo["title"]); ?></option><?php endif; endif; endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                            <label>排序：</label>
