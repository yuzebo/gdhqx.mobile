                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php if($vo['level'] == 1): ?>项目<?php elseif($vo['level'] == 2): ?><div style="color:green">模块</div><?php else: ?><div style="color:blue">操作</div><?php endif; ?></td>
                                <td><a href="<?php echo U('rbac/deletenode',array('id'=>$vo['id']));?>">删除</a></td>
